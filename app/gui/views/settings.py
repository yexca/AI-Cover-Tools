...
class SettingsPage(QWidget):
    ...
    def __init__(self, translator: Translator, appearance: AppearanceSettings, parent: QWidget | None = None) -> None:
        ...
        form.addRow(self._background_label, background_row)
        ...
        form.addRow(self._blur_label, blur_row)
        ...
        form.addRow(self._tint_opacity_label, tint_opacity_row)
        ...
        form.addRow(self._tint_color_label, tint_color_row)
